  ...
  return (
    <section className="AddTour-section">
      <div className="main-customer">
        <Heading heading={"Add Tour"} controlimg={controlimg} />

        <div className="AddTour-main-box">
          <Tabs>
            <div className="AddTour-tab-head">
              <TabList>
                <Tab>Content</Tab>
                <Tab>Location</Tab>
                <Tab>Pricing</Tab>
            ...
            <div className="AddTour-tab-list">
              <TabPanel>
                <div className="TourTitle-input-main-box">
                  <div className="TourTitle-input-box">
                    ...
                    <div className="TourTitle-input-group">
                      <label htmlFor="">Tour Content</label>
                      <input type="text" />
                    </div>
                  </div>
              ...
              <TabPanel>
                <div className="TourTitle-input-main-box">
                  ...
                  <div className="TourTitle-input-box-1">
                    <div className="TourTitle-input-box-1-h2">
                      <h2>Extra Price</h2>
                    </div>
                    <div className="TourTitle-input-group more-with-low">
                      <label htmlFor="">Add Services Per Booking</label>
                      <input type="text" />
                    </div>
                    ...
                    <div class="checkbox-wrapper">
                      ...
                      <label class="terms-label" for="terms-checkbox-3">
                        ...
                        >
                          ...
                          <rect
                            mask="url(#path-1-inside-1_476_5-3)"
                            stroke-width="40"
                            class="checkbox-box"
                            height="200"
                            width="200"
                    ...
                    <div class="checkbox-wrapper">
                      ...
                      <label class="terms-label" for="terms-checkbox-4">
                        ...
                        >
                          ...
                          <rect
                            mask="url(#path-1-inside-1_476_5-4)"
                            stroke-width="40"
                            class="checkbox-box"
                            height="200"
                            width="200"
                    ...
                    <div class="checkbox-wrapper">
                      ...
                      <label class="terms-label" for="terms-checkbox-5">
                        ...
                        >
                          ...
                          <rect
                            mask="url(#path-1-inside-1_476_5-5)"
                            stroke-width="40"
                            class="checkbox-box"
                            height="200"
                            width="200"
